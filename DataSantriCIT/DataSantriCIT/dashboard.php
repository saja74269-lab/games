...
<head>
    ...
    <title>Dashboard - Data Santri CIT</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class="fas fa-users"></i><span>Data Santri</span></a></li>
            <li><a href="#"><i class="fas fa-book"></i><span>data santri</span></a></li>
            <li><a href="#"><i class="fas fa-chart-line"></i><span>Laporan</span></a></li>
            <li><a href="#"><i class="fas fa-user-tie"></i><span>Guru</span></a></li>
            <li><a href="#"><i class="fas fa-cog"></i><span>Pengaturan</span></a></li>
               <li><a href="BACKUP.PHP"><i class="fas fa-cog"></i><span>BACKUP</span></a></li>
        </ul>
    </div>
        ...
        <div class="welcome-card">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0">Sistem Monitoring Hafalan Santri - Pondok Pesantren</p>
                </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    ...
                    <div class="stats-label">Hafalan Aktif</div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    ...
                    <div class="stats-label">Prestasi Bulan Ini</div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card">
        ...
        <div class="row">
            <div class="col-md-8 mb-4">
                <div class="chart-container">
                    <h5 class="mb-3"><i class="fas fa-chart-bar me-2"></i>Progress Hafalan Bulanan</h5>
                    <canvas id="monthlyChart" height="100"></canvas>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="chart-container">
                    <h5 class="mb-3"><i class="fas fa-pie-chart me-2"></i>Distribusi Hafalan</h5>
