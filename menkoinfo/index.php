...
if (isset($_GET['edit'])) {
    $id = intval($_GET['edit']);
    $result = $conn->query("SELECT * FROM karyawan WHERE idkar=$id");
...
<div class="container">
    ...
    <div class="output">
        <?php
        $data = $conn->query("SELECT * FROM karyawan ORDER BY idkar ASC");
        while ($row = $data->fetch_assoc()) {
            ...
            <div>
                ...
                <span class='actions'>
                    ...
                    <a href='aksi.php?hapus={$row['idkar']}' onclick=\"return confirm('Hapus data?');\">Hapus</a>
                </span>
            </div>";
        }
        ?>
